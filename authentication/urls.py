...
from authentication.views import UserLoginView, UserRegistrationView, UserConfirm, UserLogoutView, ActivateAccountView, ForgotPasswordView, ResetPasswordView
